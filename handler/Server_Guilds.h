...
namespace Re_Ps {
	...
	enum { SETTINGS_0 = 1 << 0, SETTINGS_1 = 1 << 1, SETTINGS_2 = 1 << 2, SETTINGS_3 = 1 << 3, SETTINGS_4 = 1 << 4, SETTINGS_5 = 1 << 5,SETTINGS_6 = 1 << 6, SETTINGS_7 = 1 << 7, SETTINGS_8 = 1 << 8, SETTINGS_9 = 1 << 9, SETTINGS_10 = 1 << 10, SETTINGS_11 = 1 << 11, SETTINGS_12 = 1 << 12, SETTINGS_13 = 1 << 13, SETTINGS_14 = 1 << 14, SETTINGS_15 = 1 << 15, SETTINGS_16 = 1 << 16, SETTINGS_17 = 1 << 17, SETTINGS_18 = 1 << 18, };
...
void save_guilds() {
	for (Guild to_save : guilds) {
		if (to_save.guild_settings & Re_Ps::SETTINGS_0) {
			to_save.guild_settings &= ~Re_Ps::SETTINGS_0;
			json save_;
...
bool guild_access(const ENetPeer* peer, const uint32_t guild_id) {
	...
	if (p != guilds.end()) {
		...
		if (guild_information->guild_settings & Re_Ps::SETTINGS_1) {
			return true;
		}
		else {
			if (guild_information->guild_settings & Re_Ps::SETTINGS_2 and my_rank >= 1 and my_rank != 3 or guild_information->guild_settings & Re_Ps::SETTINGS_3 and my_rank == 2) {
				return true;
			}
		}
	}
...
void create_guild_log(Guild* guild_information, string log_text, int log_display) {
	...
	guild_information->guild_settings &= ~Re_Ps::SETTINGS_0;
	guild_information->guild_settings |= Re_Ps::SETTINGS_0;
...
string get_player_tag(string name) {
	...
	if (ifs.is_open()) {
		json j;
		ifs >> j;
		if (j["owner_server"] == 1) return "`b@" + name;
		else if (j["dev"] == 1) return "`6@" + name;
